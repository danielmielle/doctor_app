...
class _BookingPageState extends State<BookingPage> {
  ...
  ///get the token for insert booking
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      return InkWell(
                        ...
                        onTap: () {
                          ///when selected, update current index and set time selected
                          setState(() {
                            _currentIndex = index;
                            _timeSelected = true;
                          });
            ...
            child: Container(
              ...
              child: Button(
                ...
                onPressed: () async {
                  ...
                  ///if booking return status 200, then redirect to success_booking page
                  if (booking == 200) {
